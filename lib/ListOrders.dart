  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text('سبد خرید',style: TextStyle(color: Color(0xff494949)),),
          ...
          actions: [
              InkWell(
                onTap: (){
                  Navigator.pop(context,widget.mains);
                },
                child: Padding(
                                ...
                                Row(
                                  children: [
                                    ...
                                    InkWell(
                                        ...
                                        child: SvgPicture.asset('assets/minuss.svg',width: 30,height: 30,color: Colors.black38)),
                                    SizedBox(width: 16,),
                                    ...
                                    InkWell(
                                        ...
                                        child: SvgPicture.asset('assets/pluss.svg',width: 30,height: 30,color: Colors.redAccent,)),
                                    SizedBox(width: 8,),
                                    Expanded(child: Row(
                                      children: [
                                        Expanded(child: Align(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Expanded(child: Align(
                                      alignment: Alignment.centerRight,
                                      child: TextApp(SplitPrice2(SumAllFactor),18,Colors.black54,true))),
                                  SizedBox(width: 8,),
                                  Align(
                                      alignment: Alignment.centerRight,
                                      child: TextApp(' : جمع كل مبلغ ',18,Colors.black38,true)),
                                  SizedBox(width: 8,),
                                ],
                              ),
                              Container(
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(child: Align(
                                      alignment: Alignment.centerRight,
                                      child: TextApp(widget.mains.length.toString(),18,Colors.black54,true))),
                                  SizedBox(width: 8,),
                                  TextApp(' : جمع كل اقلام ',18,Colors.black38,true),
                                  SizedBox(width: 8,),
                                ],
                              ),
